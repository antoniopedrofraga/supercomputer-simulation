...
testing: ./supercomputer/src/*/*.cpp ./testing/test_*.cpp
	g++ -std=c++14 ./testing/test_*.cpp ./supercomputer/src/*/*.cpp -o ./testing/test_supercomputer
	./testing/test_supercomputer
testing-coverage:
	g++ -std=c++14 ./testing/test_*.cpp ./supercomputer/src/*/*.cpp --coverage -o ./testing/test_supercomputer
	./testing/test_supercomputer
